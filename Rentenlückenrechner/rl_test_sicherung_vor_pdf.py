...
def berechne_rentenluecke():
   # aktuelles Jahr ermitteln
    ...
    print("die Einfluss auf die Größe der zu erwartenden Rentenlücke haben.")
    print("Da wir nicht die zukünftige steuerliche Situation zu unserem Renteneintritt kennen,")
    print("sollte das Ergebnis als Annäherung verstanden und zur Sicherheit ein entsprechender Puffer eingebaut werden.")
    print("")
